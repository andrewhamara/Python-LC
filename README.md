My python3 LeetCode solutions! Feel free to use any of the code in this repo for your own LeetCode solutions. LeetCode scoring seems to be arbitrary, so don't blame me if the scores are less than ideal.. 
